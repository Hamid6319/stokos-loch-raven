...
export default function FeaturedDeals() {
  return (
    <section className="w-full bg-white px-4 py-14 transition-colors duration-300 dark:bg-black md:px-6 lg:px-8">
      <div className="mx-auto w-full max-w-[1280px]">
        <div className="mb-8 flex items-end justify-between gap-4">
          <div>
            ...
            <h2 className="text-[34px] font-black leading-none tracking-[-0.04em] text-black transition-colors duration-300 dark:text-white md:text-[42px]">
              Featured Deals
            </h2>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {deals.map((deal) => (
            ...
            >
              <div className="relative h-[225px] w-full overflow-hidden bg-neutral-100 dark:bg-[#050505]">
                <Image
                  src={deal.image}
                  alt={deal.title}
                  fill
