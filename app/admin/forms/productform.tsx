...
const ProductForm = forwardRef<ProductFormRef, {
  item: Product | null;
  categories: Category[];
  ...
  { item, categories, modifierGroups, upsellRules = [], onSave },
  ref
) {
      ...
      <div>
        ...
        {categoryBasedUpsells.length === 0 ? (
          <div className="rounded-2xl border border-dashed border-zinc-300 bg-zinc-50 p-4 text-sm font-bold text-zinc-500">
            No upsell rules found for {form.category}. Create an upsell rule and
